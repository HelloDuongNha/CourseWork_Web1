    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <img style="width: 50px; height: 50px;" class="post-avatar" src="../images/avatar/<?= $user['avatar'] ?>">
                <h2 class="modal-title fs-5" id="postModalLabel"><?= $user['user_name'] ?></h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <div class="modal-body">
                <form action="../Share_Repost/create_repost.php" method="POST" enctype="multipart/form-data">
